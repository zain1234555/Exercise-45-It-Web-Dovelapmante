...
// let famous_peron = " Alberts Einstein";
// let message = `${famous_peron} one said ${quote}`;
// console.log(message);
...
// let personName: string = `/n/t zain zain/t/n`;
// console.log(personName);
// let stirepped: string = personName.trim();
// console.log(stirepped);
...
• Test whether an item is not in a array*/
  ...
  let name_2 : string = "ali zain"
  let name_3 : string = "sir zain ali"
  if (name_1 == name_3)[
   ...
   Use the function to make three dictionaries representing different albums.
    Print each return value to show that Objects are storing the album information correctly.
     ...
     If the calling line includes a value for the number of tracks, add that value to the album’s Object.
      ...
      //    return dictionaries;
      // }
      // let album = makeAlbum("Zain", "light")
      // console.log(album)
      // album = makeAlbum("Qureshi", "Red wave")
      // console.log(album)
      // album = makeAlbum("Iqra", "Seenbreeze")
      // console.log(album)
...
// //difine to function to magicians name
//            function show_Magicians(magicians: string[]){
//                 magicians.forEach(name => console.log(name)); 
//           }
// //function to make magicians graet throhg .map() it wil modifay array
//          function make_great(magicians:string[]){
//             return magicians.map(name => `the great ${name}`)
//          }
// //difine an array of magicians names
//          let magicians_name = ["zain","Qureshi","ali"];
...
// // show both arrays orignal and copide
...
// show_Magicians(copy_magician_names);
        ...
        //     }
        //    }
        //    console.log("enjoy your sandwich zain Qureshi")
